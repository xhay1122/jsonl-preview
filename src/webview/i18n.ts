const zh = {
  ...
  copyKey: '复制属性名', copyValue: '复制值', copyCell: '复制单元内容', copyJson: '复制 JSON', copyPath: '复制 JSONPath', openTemp: '在临时 Tab 中打开',
  fullContent: '完整内容', line: '第 {line} 行', copyLine: '复制整行', tempTab: '临时 Tab', preparing: '正在准备预览…', expression: '表达式：{value}', results: '{count} 条结果'
} as const;
...
const en: Record<keyof typeof zh, string> = {
  ...
  copyKey: 'Copy Property Name', copyValue: 'Copy Value', copyCell: 'Copy Cell', copyJson: 'Copy JSON', copyPath: 'Copy JSONPath', openTemp: 'Open in Temporary Tab',
  fullContent: 'Full Content', line: 'Line {line}', copyLine: 'Copy Row', tempTab: 'Temporary Tab', preparing: 'Preparing preview…', expression: 'Expression: {value}', results: '{count} results'
};
