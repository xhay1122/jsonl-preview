const zh = {
  ...
  fullContent: '完整内容', searchContent: '在完整内容中搜索', previousMatch: '上一个匹配项', nextMatch: '下一个匹配项', matchCount: '{current}/{total}', copyContent: '复制内容', copySelected: '复制选中内容', openSelectedTemp: '临时 Tab 打开', line: '第 {line} 行', copyLine: '复制整行', tempTab: '临时 Tab 打开', currentTab: '当前 Tab 打开', preparing: '正在准备预览…', expression: '表达式：{value}', results: '{count} 条结果'
} as const;
...
const en: Record<keyof typeof zh, string> = {
  ...
  fullContent: 'Full Content', searchContent: 'Search full content', previousMatch: 'Previous match', nextMatch: 'Next match', matchCount: '{current}/{total}', copyContent: 'Copy Content', copySelected: 'Copy Selected Content', openSelectedTemp: 'Open Selection in Temporary Tab', line: 'Line {line}', copyLine: 'Copy Row', tempTab: 'Temporary Tab', currentTab: 'Current Tab', preparing: 'Preparing preview…', expression: 'Expression: {value}', results: '{count} results'
};
