const zh = {
  ...
  copyKey: '复制属性名', copyValue: '复制值', copyCell: '复制单元内容', copyJson: '复制 JSON', copyPath: '复制 JSONPath', openTemp: '在临时 Tab 中打开', openCurrent: '在当前 Tab 打开', openRowTemp: '临时 Tab 打开（整行）', openRowCurrent: '当前 Tab 打开（整行）', openCellTemp: '临时 Tab 打开（单元格）', openCellCurrent: '当前 Tab 打开（单元格）',
  fullContent: '完整内容', copyContent: '复制内容', copySelected: '复制选中内容', openSelectedTemp: '临时 Tab 打开', line: '第 {line} 行', copyLine: '复制整行', tempTab: '临时 Tab 打开', currentTab: '当前 Tab 打开', preparing: '正在准备预览…', expression: '表达式：{value}', results: '{count} 条结果'
} as const;
...
const en: Record<keyof typeof zh, string> = {
  ...
  copyKey: 'Copy Property Name', copyValue: 'Copy Value', copyCell: 'Copy Cell', copyJson: 'Copy JSON', copyPath: 'Copy JSONPath', openTemp: 'Open in Temporary Tab', openCurrent: 'Open in Current Tab', openRowTemp: 'Open in Temporary Tab (Row)', openRowCurrent: 'Open in Current Tab (Row)', openCellTemp: 'Open in Temporary Tab (Cell)', openCellCurrent: 'Open in Current Tab (Cell)',
  fullContent: 'Full Content', copyContent: 'Copy Content', copySelected: 'Copy Selected Content', openSelectedTemp: 'Open Selection in Temporary Tab', line: 'Line {line}', copyLine: 'Copy Row', tempTab: 'Temporary Tab', currentTab: 'Current Tab', preparing: 'Preparing preview…', expression: 'Expression: {value}', results: '{count} results'
};
