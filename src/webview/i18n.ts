const zh = {
  ...
  fullContent: '完整内容', copyContent: '复制内容', line: '第 {line} 行', copyLine: '复制整行', tempTab: '临时 Tab 打开', currentTab: '当前 Tab 打开', preparing: '正在准备预览…', expression: '表达式：{value}', results: '{count} 条结果'
} as const;
...
const en: Record<keyof typeof zh, string> = {
  ...
  fullContent: 'Full Content', copyContent: 'Copy Content', line: 'Line {line}', copyLine: 'Copy Row', tempTab: 'Temporary Tab', currentTab: 'Current Tab', preparing: 'Preparing preview…', expression: 'Expression: {value}', results: '{count} results'
};
